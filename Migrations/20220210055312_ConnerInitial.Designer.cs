...
namespace Project6.Migrations
{
    ...
    [Migration("20220210055312_ConnerInitial")]
    partial class ConnerInitial
    {
            ...
            modelBuilder.Entity("Project6.Models.TaskInputModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 2,
                            Completed = false,
                            DueDate = new DateTime(2022, 2, 9, 22, 53, 12, 286, DateTimeKind.Local).AddTicks(3261),
                            QuadrantId = 1,
                        ...
                        new
                        {
                            ...
                            CategoryId = 3,
                            Completed = false,
                            DueDate = new DateTime(2022, 2, 9, 22, 53, 12, 289, DateTimeKind.Local).AddTicks(1759),
                            QuadrantId = 2,
                            Task = "Study for Exam"
                        },
                        new
                        {
                            ...
                            CategoryId = 3,
                            Completed = false,
                            DueDate = new DateTime(2022, 2, 9, 22, 53, 12, 289, DateTimeKind.Local).AddTicks(1847),
                            QuadrantId = 3,
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Completed = false,
                            DueDate = new DateTime(2022, 2, 9, 22, 53, 12, 289, DateTimeKind.Local).AddTicks(1855),
                            QuadrantId = 4,
                            Task = "Sleep"
                        });
                });
